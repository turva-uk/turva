...
const VerifyNoticePage = () => {
  ...
  return (
    <Box>
      ...
      <ErrorDisplay title="An error occurred while resending the verification email." error={resendError} />
      <p>
      ...
      <Button mt="md" fullWidth variant="outline" onClick={() => handleResend()}>
